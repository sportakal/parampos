...
class PreAuthPaymentModel implements PaymentInterface
{
    use MakeRequest;
    ...
    protected $wsdl = 'TP_Islem_Odeme_OnProv_WMD';
     ...
     * @return PreAuthPaymentModel
     */
    public function setSecureType(string $secure_type): PreAuthPaymentModel
    {
